...
from synthergent.base.data.sdf import ScalableDataFrameOrRaw
...
from synthergent.base.constants import DataLayout, MLType, DataPosition, MLTypeSchema
from synthergent.base.util import optional_dependency, safe_validate_arguments, MappedParameters, get_default, check_isinstance
...
with optional_dependency('torch'):
    ...
    from synthergent.base.data.sdf.TorchScalableSeries import TorchScalableSeries
