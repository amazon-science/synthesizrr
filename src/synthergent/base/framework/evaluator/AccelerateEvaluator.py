...
from synthergent.base.util import type_str, optional_dependency, as_list, get_default, EnvUtil, set_param_from_alias, \
    FileSystemUtil
from synthergent.base.data import FileMetadata
from synthergent.base.framework.evaluator.LocalEvaluator import LocalEvaluator
...
from synthergent.base.framework.task import LanguageModelTaskMixin, GenerativeLM
...
with optional_dependency('accelerate', 'torch', 'transformers'):
    ...
    class AccelerateEvaluator(LocalEvaluator):
        ...
        def _load_model(
            ...
            from synthergent.base.algorithm.alexa_teacher_models import AlexaTMSeq2Seq, ALEXA_TM_SEQ2SEQ_MODEL_NAMES
        ...
        def _load_hf_auto_model_class(
            ...
            from synthergent.base.algorithm.huggingface.transformers import HFPyTorchModel
        ...
        def _load_alexa_tm_model_copy(
            ...
            from synthergent.base.algorithm.alexa_teacher_models import AlexaTMSeq2Seq
            if num_devices % 2 != 0:
