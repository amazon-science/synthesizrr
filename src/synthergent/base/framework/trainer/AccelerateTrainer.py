...
from synthergent.base.util import Log, optional_dependency, safe_validate_arguments, any_are_none, get_default, \
...
with optional_dependency('accelerate', 'torch'):
    from synthergent.base.framework.dl.torch import PyTorch, is_accelerator
