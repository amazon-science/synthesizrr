...
from synthergent.base.util import optional_dependency, set_param_from_alias, Parameters, get_default, safe_validate_arguments, \
    ignore_warnings, as_list, format_exception_msg
from synthergent.base.data import FileMetadata
from synthergent.base.data import ScalableDataFrame, ScalableSeries
from synthergent.base.constants import MLType, Storage, Alias
...
with optional_dependency('torch', 'sentencepiece', 'transformers', 'tokenizers', 'huggingface_hub'):
    ...
    from synthergent.base.framework import Dataset, Classifier, EncodingRange
    from synthergent.base.framework.dl.torch import PyTorch, Loss, Optimizer, LRScheduler, \
    ...
    from synthergent.base.framework.task.text_generation import GenerativeLM, Prompts, NextTokens, GenerationOutputScoresFormat, \
