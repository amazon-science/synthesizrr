...
from synthesizrr.base.framework.task import Embedder, \
    EncodingRange, Classifier, ClassificationData, MultiLabelClassifier, MultiLabelClassificationData, \
    Regressor
from synthesizrr.base.constants import Task, TaskOrStr, MLType, Storage
from synthesizrr.base.data import FileMetadata
from synthesizrr.base.util import optional_dependency, FileSystemUtil
...
with optional_dependency('torch'):
    ...
    from synthesizrr.base.framework.dl.torch.torch_base import PyTorch, Loss, Optimizer, LRScheduler, \
